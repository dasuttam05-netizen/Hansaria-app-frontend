...
const styles = {
  ...
  tableOuter: { width: '100%', maxWidth: '100%', overflowX: 'auto', overflowY: 'visible', WebkitOverflowScrolling: 'touch', background: '#fff', border: '1px solid #dbe4ee', borderRadius: 14, boxShadow: '0 8px 22px rgba(15,23,42,.05)' },
  dataTable: { width: 'max-content', minWidth: '1700px', borderCollapse: 'separate', borderSpacing: 0, tableLayout: 'auto', fontSize: 11 },
  th: { position: 'sticky', top: 0, zIndex: 3, background: '#0f766e', color: '#fff', padding: '8px 9px', textAlign: 'left', fontWeight: 900, whiteSpace: 'nowrap', borderRight: '1px solid rgba(255,255,255,.14)' },
  td: { padding: '8px 9px', color: '#0f172a', background: '#fff', whiteSpace: 'nowrap', borderTop: '1px solid #eef2f7', verticalAlign: 'middle' },
  tdNum: { padding: '8px 9px', color: '#0f172a', background: '#fff', whiteSpace: 'nowrap', borderTop: '1px solid #eef2f7', textAlign: 'right', fontVariantNumeric: 'tabular-nums', verticalAlign: 'middle' },
  statusChip: { display: 'inline-flex', alignItems: 'center', borderRadius: 999, padding: '4px 7px', fontSize: 9, fontWeight: 900, whiteSpace: 'nowrap' },
  actionTh: { position: 'sticky', right: 0, zIndex: 5, minWidth: 155, boxShadow: '-5px 0 10px rgba(15,23,42,.08)' },
  actionTd: { minWidth: 155, boxShadow: '-5px 0 10px rgba(15,23,42,.06)' },
  ...
  iconButton: { width: 30, height: 30, borderRadius: 8, border: '1px solid', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', background: '#fff' },
  iconEdit: { color: '#2563eb', borderColor: '#bfdbfe', background: '#eff6ff' },
  iconCopy: { color: '#7c3aed', borderColor: '#ddd6fe', background: '#f5f3ff' },
  copyButton: { color: '#7c3aed', borderColor: '#ddd6fe', background: '#f5f3ff', minWidth: 62, padding: '6px 8px', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 4, fontWeight: 800, fontSize: 11 },
  iconWhatsapp: { color: '#15803d', borderColor: '#bbf7d0', background: '#f0fdf4' },
  iconPdf: { color: '#dc2626', borderColor: '#fecaca', background: '#fef2f2' },
  iconSpacer: { width: 30, height: 30, display: 'inline-block' },
